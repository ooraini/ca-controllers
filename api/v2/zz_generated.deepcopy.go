...
func (in *GvkConfig) DeepCopyInto(out *GvkConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GvkConfig.
func (in *GvkConfig) DeepCopy() *GvkConfig {
	if in == nil {
		return nil
	}
	out := new(GvkConfig)
...
func (in *ProjectConfig) DeepCopyInto(out *ProjectConfig) {
	*out = *in
	...
	if in.GvkConfigs != nil {
		in, out := &in.GvkConfigs, &out.GvkConfigs
		*out = make([]GvkConfig, len(*in))
		copy(*out, *in)
	}
}
